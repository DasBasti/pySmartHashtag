...
INTL_SECRET = "30fb4a7b7fab4e2e8b52120d0087efdd".encode("utf-8")
...
def _create_sign(nonce: str, params: dict, timestamp: str, method: str, url: str, body=None, use_intl: bool = False, url_encode_params: bool = False) -> str:
