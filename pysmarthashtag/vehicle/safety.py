...
class Safety(VehicleDataBase):
    ...
    def _parse_vehicle_data(cls, vehicle_data: dict) -> Optional[dict]:
        ...
        try:
            ...
            retval["door_pos_driver_rear"] = get_field_as_type(evStatus, "doorPosDriverRear", int, log_missing=False)
            retval["door_pos_passenger"] = get_field_as_type(evStatus, "doorPosPassenger", int)
            retval["door_pos_passenger_rear"] = get_field_as_type(evStatus, "doorPosPassengerRear", int, log_missing=False)
